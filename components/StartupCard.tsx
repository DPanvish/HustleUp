  ...
  return (
    <li className="startup-card group">
      ...
      <Link href={`/startup/${_id}`}>
        ...
        {/* 
          You can also use regular img tag here
          Next.js Image component is used to optimize images for the web.
          It provides features like automatic optimization, lazy loading and responsive images.
        */}
        
        <img src={image} alt="startup" className="startup-card-img" />
      </Link>
